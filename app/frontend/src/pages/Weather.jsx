...
const SEV = {
  act: {
    chip: "bg-rose-50 text-rose-700 ring-rose-200 dark:bg-rose-950 dark:text-rose-300 dark:ring-rose-800",
    dot: "bg-rose-500",
  },
  watch: {
  ...
  info: {
    chip: "bg-brand-50 text-brand-700 ring-brand-200 dark:bg-brand-950 dark:text-brand-300 dark:ring-brand-800",
    dot: "bg-brand-500",
  },
  recommend: {
...
export default function Weather() {
  ...
  const run = async () => {
    ...
    if (plotId) {
      ...
      lastDisease =
        scans.find((s) => !s.abstained)?.predicted_class || null;
    }
